...
plt.plot(tempo, pos3, color='yellow', label='Runge-Kutta')
#plt.plot(tempo, pos3, color='blue', label='Runge-Kutta-Fehlberg')
plt.legend()
...
plt.plot(tempo, vel3, color='yellow', label='Runge-Kutta')
#plt.plot(tempo, vel3, color='blue', label='Runge-Kutta-Fehlberg')
plt.xlabel('tempo (s)')
